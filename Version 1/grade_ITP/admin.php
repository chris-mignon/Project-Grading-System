...
if (isset($_POST['action'])) {
    ...
    if ($action == 'add') {
        ...
        $stmt = $pdo->prepare('INSERT INTO projects2 (title, description) VALUES (:title, :description)');
        ...
        $stmt = $pdo->prepare('UPDATE projects2 SET title = :title, description = :description WHERE id = :id');
        ...
        $stmt = $pdo->prepare('DELETE FROM projects2 WHERE id = :id');
        ...
        $query = 'UPDATE users2 SET name = :name, email = :email, role = :role' . ($password ? ', password = :password' : '') . ' WHERE id = :id';
...
$stmt = $pdo->prepare('SELECT * FROM projects2');
$stmt->execute();
$projects = $stmt->fetchAll();

// Retrieve all users
$stmt_users = $pdo->prepare('SELECT * FROM users2');
$stmt_users->execute();
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addProjectForm">
                        ...
                        <div class="mb-3">
                            <label for="projectDescription" class="form-label">Student Name</label>
